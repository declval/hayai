...
class Tutorial {
    constructor(keyboard, settings) {
        ...
        this.tutorialBackgroundElement = document.getElementById('tutorial-background');

        const tutorialCloseButtonElements = document.getElementsByClassName('tutorial-close-button');
    ...
    homeRowShow = () => {
        this.tutorialHomeRowElement = document.getElementById('tutorial-home-row');
        this.keyboardHomeKeyElements = document.getElementsByClassName('keyboard-home-key');
        ...
        const tutorialHomeRowButtonElement = document.getElementById('tutorial-home-row-button');
    ...
    fingersShow = () => {
        this.tutorialFingersElement = document.getElementById('tutorial-fingers');
        ...
        const tutorialFingersButtonElement = document.getElementById('tutorial-fingers-button');
    ...
    settingsShow = () => {
        this.tutorialSettingsElement = document.getElementById('tutorial-settings');
        const keyboardElement = document.getElementById('keyboard');
        ...
        const tutorialSettingsButtonElement = document.getElementById('tutorial-settings-button');
    ...
    open = () => {
        ...
        this.tutorialBackgroundElement.classList.add('tutorial-background-show');
        this.keyboard.guideOff();
        this.settings.close();
        this.homeRowShow();
    }
    ...
    close = () => {
        this.tutorialOpen = false;
        this.tutorialBackgroundElement.classList.remove('tutorial-background-show');
        this.homeRowHide();
        this.fingersHide();
        this.settingsHide();
    }
